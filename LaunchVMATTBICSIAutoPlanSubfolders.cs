...
namespace VMS.TPS
{
    public class Script
    {
        ...
        {
            return FirstExePathIn(GetSourceFileDir(), exeName);
        }
        ...
        /// <param name="sourceFilePath"></param>
        /// <returns></returns>
        private string GetSourceFileDir([CallerFilePath] string sourceFilePath = "")
        {
            return Path.Combine(Path.GetDirectoryName(GetSourceFilePath()), "bin");
        }
    }
}
